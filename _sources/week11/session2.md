...
- **언어 모델 지식**: GPT-3, GPT-4, Google Bard 등 대규모 언어 모델의 작동 방식과 구조에 대한 깊은 이해.
- **다양한 언어의 훈련**: 영어가 주로 사용되지만, 여러 언어로 훈련된 모델을 이해하고 활용할 수 있는 능력.

### 강한 커뮤니케이션 능력

- **기술적 개념 설명**: 복잡한 기술적 개념을 명확하게 설명할 수 있는 능력.
- **언어와 맥락 이해**: 어휘, 뉘앙스, 구문, 맥락 및 언어학에 대한 깊은 이해.
...
- **코딩 원리**: 코드 생성을 목표로 할 때 필요한 코딩 원리와 프로그래밍 언어에 대한 이해.
- **Python 능숙**: Python 등 프로그래밍 언어에서 능숙하게 작업할 수 있는 능력.
...
- **창의적 해결책**: 새로운 기술의 이점과 위험을 현실적으로 평가하고 창의적인 해결책을 제시할 수 있는 능력.
- **예술, 사진, 영화 용어**: 이미지 생성기와 작업할 때 필요한 예술사, 사진, 영화에 대한 지식.
...
- **제로샷 프롬프팅**: 모델이 명시적으로 훈련되지 않은 작업에 대해 관련 출력을 생성할 수 있는 능력을 테스트.
- **퓨샷 프롬프팅 또는 인-컨텍스트 러닝**: 모델에 몇 가지 예시 출력을 제공하여 원하는 출력을 더 잘 이해하도록 돕는 기술.
- **사고의 연쇄 프롬프팅**: 모델이 복잡한 작업을 중간 단계로 나누어 더 나은 언어 이해와 정확한 출력을 생성하도록 돕는 고급 기술.
