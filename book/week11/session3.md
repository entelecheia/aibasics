...
- AI 에이전트가 결정을 내리는 데 사용하는 데이터에 편향이 존재하는 경우
- 아마존의 AI 채용 도구가 여성에 대한 편향으로 인해 채용 과정에서 불공정한 결과를 초래
...
- 인간의 개입 없이 결정을 내리는 프로액티브 에이전트의 책임 소재 불명확
- 우버 자율 주행 차량이 보행자를 치어 사망에 이르게 한 사건
- **결과**: 책임소재 규명의 어려움
...
- 학습 에이전트의 결정 과정이 복잡하고 불투명하여 이해하기 어려움
...
- 윤리적 영향을 미칠 수 있는 결정을 내리는 합리적 에이전트
- 마이크로소프트의 챗봇 Tay가 인종차별적이고 성차별적인 발언을 시작
...
- 사이버 공격에 취약하여 결정 과정이나 데이터 유출에 영향을 줄 수 있음
...
- 훈련 데이터에 따라 행동하는 자율 AI 에이전트가 새로운 상황이나 맥락에 적응하는 데 어려움을 겪음
